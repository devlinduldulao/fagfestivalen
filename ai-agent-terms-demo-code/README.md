...
```bash
python 01-agents-md/demo_agents_md.py 01-agents-md/app/services
```
...
```bash
python 02-agent-skills/agent.py "make a conference deck outline"
python 02-agent-skills/agent.py "review this code for secrets"
```
...
```bash
python 05-subagents/subagents_demo.py
```
